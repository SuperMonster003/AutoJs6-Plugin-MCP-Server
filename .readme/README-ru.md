...
Локальная сеть: включите "Разрешить подключения из локальной сети" на странице настроек. Страница покажет текущие адреса телефона (они следуют за изменениями Wi-Fi) и напомнит, что клиент должен быть в той же сети; гостевые сети, изоляция точки доступа и брандмауэр ПК мешают чаще всего. Запросы сопряжения из локальной сети помечаются, а пока сервер доступен из сети, ежедневное уведомление напоминает об этом; напоминание можно отключить. На Android 17 и новее разрешите этому плагину доступ к устройствам поблизости для подключения к локальной сети. Разрешение AutoJs6 не распространяется на плагин. Общедоступный интернет и петлевые соединения не требуют этого разрешения. Если операция использует локальную сеть, откройте этот плагин из центра плагинов AutoJs6 и разрешите устройства поблизости. Разрешение AutoJs6 не распространяется на плагин.
...
- На Android 17 и новее разрешите этому плагину доступ к устройствам поблизости для подключения к локальной сети. Разрешение AutoJs6 не распространяется на плагин. Общедоступный интернет и петлевые соединения не требуют этого разрешения.
