...
Предварительная версия P3.5: доступны 37 инструментов, 33 включены по умолчанию. Поддерживаются файлы, позиции редактора, поиск приложений, буфер обмена, автоматическое включение специальных возможностей и Shell с ограничением вывода. Переключатель меню и настройки запланированы на P4. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-MCP-Server/blob/master/ROADMAP.md).
...
- `Подсказка` Предварительная версия P3.5: доступны 37 инструментов, 33 включены по умолчанию. Поддерживаются файлы, позиции редактора, поиск приложений, буфер обмена, автоматическое включение специальных возможностей и Shell с ограничением вывода. Переключатель меню и настройки запланированы на P4. ROADMAP.md.
