...
> В этой предварительной версии используйте управление adb и тестовый сеанс хоста из заметок для разработчиков; переключатель в меню и настройки плагина запланированы в P4.
...
В этой предварительной версии токен читается через adb в режиме разработчика, как описано в документации для разработчиков. Отображение токена в настройках запланировано на P4.
...
- `Подсказка` Предварительная версия P3.4: доступны 37 инструментов, 33 включены по умолчанию. Поддерживаются файлы, позиции редактора, поиск приложений, буфер обмена, автоматическое включение специальных возможностей и Shell с ограничением вывода. Переключатель меню и настройки запланированы на P4. ROADMAP.md.
