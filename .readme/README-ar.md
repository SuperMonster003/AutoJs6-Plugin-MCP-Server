...
يستخدم المساران نفس الرمز ونفس الاقتران على الهاتف. جسر stdio للعملاء الذين لا يدعمون HTTP مخطط له بشكل منفصل.
...
Claude Desktop يشغل خوادم stdio فقط; برنامج جسر له مخطط (انظر خارطة الطريق).
