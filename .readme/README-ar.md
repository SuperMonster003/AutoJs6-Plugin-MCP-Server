...
- `تلميح` معاينة التطوير P3.5: تتوفر 37 أداة, منها 33 مفعلة افتراضيا. تشمل الملفات وتحديد موضع المحرر واستعلام التطبيقات والحافظة والتفعيل التلقائي لإمكانية الوصول و Shell مع حدود للمخرجات. مفتاح القائمة وصفحة الإعدادات مقرران في P4. ROADMAP.md.
